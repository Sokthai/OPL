...
ok(scm_equal(scm_eval("(begin (define s (make-monitored (lambda (n) (* n n)))) (s 10) (s 10) (s 'reset-count) (s 'how-many-calls?))"), "0"), "make-monitored count reset to zero");
ok(scm_equal(scm_eval("(begin (define s (make-monitored (lambda (n) (* n n)))) (s 10) (s 10) (s 'reset-count) (s 10) (s 'how-many-calls?))"), "1"), "make-monitored count continues after reset");
