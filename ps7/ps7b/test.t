...
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   (uml:define n 0) 
                                   (uml:for (i 1 3) 
                                     (uml:set! n (uml:+ n i)))
                                   n)
                         the-global-environment)"), "6"),
   "uml:for -- loop from 1 to 3");
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   (uml:define n 0)
                                   (uml:for (i 1 1)
                                     (uml:set! n (uml:+ n i)))
   ...
   "uml:for -- loop from 1 to 1 (should run once)");
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   (uml:define n 0)
                                   (uml:for (i -5 10)
                                     (uml:set! n (uml:+ n i)))
...
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   ...
                                   n)
                         the-global-environment)"), "6"),
   "uml:for -- loop from (+ 1 0) to 3");
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   (uml:define n 0)
                                   (uml:for (i 1 1000)
                                     (uml:set! n (uml:+ n i)))
                                   n)
                         the-global-environment)"), "500500"),
   "uml:for -- loop from 1 to 1000");
ok(scm_equal(scm_eval("(mc-eval '(uml:begin
                                   (uml:define n 0)
                                   (uml:for (i 1 3)
                                     (uml:for (j 1 3)
